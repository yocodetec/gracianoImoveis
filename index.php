...
<html>
	...
	<body>
        		 ...
        		 <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white border-bottom">
                      <div class="container-fluid">
                        <a class="navbar-brand" href="index.php">
                        	 <!-- LOGO DA EMPRESA -->
                             <img src="img/logo_graciano.png" alt="" width="150px" height="70px" class="">
                        </a>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="#central">Sobre nós</a>
                            </li>
                            <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Serviços
		     ...
		     <div class="row">
		     <!-- BANNER -->
    		 <div id="banner" class="col-sm-12 parallax darkened-image">
			...
			<div id="div2" class="col-sm-12">
    			...
    			<div id="card-group" class="col-sm-12 cards">
                    <div class="col-3 card comprador">
                        <div class="icon">
                    ...
                    <div class="col-sm-3 card inquilinos">
                        <div class="icon">
                    ...
                    <div class="col-sm-3 card proprietarios">
                        <div class="icon">
			...
			<div id="central" class="col-sm-12">
            		...
            		<div id="div4" class="col-sm-6">
          				<img class="col-sm-4 personagem-div4" src="img/img_div9.png">
    					<div class="col-sm-8 texto-div4"> 
                	...
                	<script>
                        ...
                        <div id="img-div4" class="col-sm-4">
                            <!-- IMAGEM ESQUERDA -->
            			</div>	
    				</div>
			...
			<div id="div-hidden" class="col-sm-10">
				<div class="row">
            		<div id="div-missao" class="col-sm-12 divs-hidden">
            		...
            		<div id="div-visao" class="col-sm-12 divs-hidden">
            		...
            		<div id="div-valores" class="col-sm-12 divs-hidden">
    		...
    		<div id="div5" class="col-sm-12">
               ...
               <div id="carrosel" class="col-sm-12 cards">
               ...
               <div class="botao-div5">
                     <button class="col-sm-2 btn btn-dark" type="button">Veja mais</button>
               </div>
        	...
        	<div class="container-fluid">
        	<div class="row">
                <div id="footer" class="col-sm-12 container-footer">
