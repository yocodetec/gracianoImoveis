...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-ligth bg-light">
        <div class="container-fluid">
            <a href="frontIndex.php" class="navbar-brand">
     ...
     <div class="container">
        ...
        <div class="col-sm-6">
             <div id="menu">
                <ul>
                  <li><a onclick="carregar('forms/Clientes.html')" id="link" href="#">ADICIONAR UM CLIENTE</a></li>
                  ...
                  <li><a onclick="carregar('forms/Especialidades.php')"  href="#">ESPECIALIDADES</a></li>
