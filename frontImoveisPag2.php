    			...
    			<div id="div5" class="divlinha1 col-md-6 col-sm-12 col-xs-12 col-lg-6">
					<div id="cards" class="div8 col-md-12 col-sm-12 col-xs-12 col-lg-12">
                  		<div class="col-md-3 col-sm-3 col-xs-3 col-lg-3 card-body">
                  			<div id="testeimg" class="imgs">
                  				<a href="frontModeloDiv5.php">
                  					<img src="img/div5-1.png" width="" height="" alt="">
                  				</a>
                  			</div>
                  			<div class="texto">
                  				<h5>Apartamentos</h5>
                  				<p>Vila Maricy – Guarulhos – SP <br/>
                                 2 quartos | 1 banheiro <br/>
                                 Locação:
                                 R$ 1.250,00</p>
                            </div>
               				<button type="button" name="btn_imovel5" id="btn_imovel5" onClick="btn_imovel5()">Ver detalhes</button>
              			</div>
               		</div>
    			</div>
    			<div id="div5" class="divlinha1 col-md-6 col-sm-12 col-xs-12 col-lg-6">
    				<div id="cards" class="div8 col-md-12 col-sm-12 col-xs-12 col-lg-12">
					   <div class="col-md-3 col-sm-3 col-xs-3 col-lg-3 card-body">
					   		<div class="imgs">
						   		<a href="frontModeloDiv6.php">
                  					<img src="img/div6-1.png" width="" height="" alt="">
                  				</a>
                  			</div>
                  			<div class="texto">
                 				<h5>Apartamentos</h5>
               					<p>Vila Camargos – Guarulhos – SP<br/>
                                 3 quartos | 1 banheiros <br/>
                                 Locação:
                                 R$ 1.750,00</p>
                           </div>
              				<button type="button" name="btn_imovel6" id="btn_imovel6" onClick="btn_imovel6()">Ver detalhes</button>
                 		</div>
           			</div>
    			</div>
    		</div>
    		...
    		<div class="row">
    			<div id="div6" class="divlinha2 col-md-6 col-sm-12 col-xs-12 col-lg-6">
    				<div id="cards" class="div8 col-md-12 col-sm-12 col-xs-12 col-lg-12">
                  		<div class="col-md-3 col-sm-3 col-xs-3 col-lg-3 card-body">
                  			<div class="imgs">
                  				<a href="frontModeloDiv7.php">
                  					<img src="img/div7-1.png" width="" height="" alt="">
                  				</a>
                  			</div>
               				<div class="texto">
             					<h5>Apartamentos</h5>
              					<p>Cocaia – Guarulhos – SP<br/>
                                 3 quartos | 2 banheiros <br/>
                            	 Locação:
                                 R$ 2.000,00</p>
                           </div>
                  			<button type="button" name="btn_imovel7" id="btn_imovel7" onClick="btn_imovel7()">Ver detalhes</button>
                  		</div>
                 	</div>
    			</div>
    			<div id="div6" class="divlinha2 col-md-6 col-sm-12 col-xs-12 col-lg-6">
					<div id="cards" class="div8 col-md-12 col-sm-12 col-xs-12 col-lg-12">
                  		<div class="col-md-3 col-sm-3 col-xs-3 col-lg-3 card-body">
               				<div class="imgs">
                   				<a href="frontModeloDiv8.php">
                      				<img src="img/div8-1.png" width="" height="" alt="">
                      			</a>
                      		</div>
                      		<div class="texto">
                      			<h5>Casas</h5>
                      			<p>Parque Renato Maia – Guarulhos – SP<br/>
                                 4 quartos | 1 banheiros <br/>
                                 Locação:
                                 R$ 6.000,00</p>
                           	</div>
                   			<button type="button" name="btn_imovel8" id="btn_imovel8" onClick="btn_imovel8()">Ver detalhes</button>
                   		</div>
               		</div>
    			</div>
    			<nav aria-label="Page navigation example">
  						<ul class="pagination">
        					...
        					<li class="page-item"><a class="page-link" href="#" onclick="mudaparaPag2.php()">2</a></li>
    					</ul>
    				</nav>
    			</div>
    		</div>
